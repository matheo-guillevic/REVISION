...
subject: "math"
type: "exam"
target: "math-exam-partiel-2.html"
eyebrow: "Partiel 2"
...
**Ã‰tape 1 : DÃ©finition des Ã©vÃ¨nements et extraction des donnÃ©es.**
 On note \(B, R, N\) les Ã©vÃ¨nements de choix de la piste (Bleue, Rouge, Noire) et \(T\) l'Ã©vÃ¨nement "tomber". DonnÃ©es : \(\mathbb{P}(B)=1/4\), \(\mathbb{P}(R)=1/2\), \(\mathbb{P}(N)=1/4\). ProbabilitÃ©s conditionnelles : \(\mathbb{P}(T|B)=1/10\), \(\mathbb{P}(T|R)=1/6\), \(\mathbb{P}(T|N)=2/5\).
