...
:::figure src="assets/IN363-Reseau/pile-reseau.svg" alt="Pile reseau simplifiee : application, transport, IP, Ethernet et physique." caption="Reflexe central : chaque couche ajoute ou interprete une information differente autour des donnees utiles." label="Synthese de la pile reseau IN363"
...
Si le recepteur lit \(0110111\), les tests de parite donnent :

| Test | Positions verifiees | Bits lus | Resultat |
|---|---|---|---|
| \(s_1\) | \(1,3,5,7\) | \(0,1,1,1\) | \(s_1=1\) |
| \(s_2\) | \(2,3,6,7\) | \(1,1,1,1\) | \(s_2=0\) |
| \(s_4\) | \(4,5,6,7\) | \(0,1,1,1\) | \(s_4=1\) |

| Syndrome | Valeur binaire | Valeur decimale | Correction |
|---|---:|---:|---|
| \(s_4s_2s_1\) | \(101_2\) | 5 | Erreur en position 5 : on inverse ce bit et on retrouve \(0110011\). |
:::
...
| Etape | Lecture | Prefixe deja connu | Nouveau symbole | Sortie | Nouvelle entree du dictionnaire |
|---:|---|---|---|---|---|
| 1 | \(A\) | vide | \(A\) | \((0,A)\) | \(1 : A\) |
| 2 | \(B\) | vide | \(B\) | \((0,B)\) | \(2 : B\) |
| 3 | \(AB\) | \(A\) | \(B\) | \((1,B)\) | \(3 : AB\) |
| 4 | \(ABA\) | \(AB\) | \(A\) | \((3,A)\) | \(4 : ABA\) |
...
*   **Manchester** : le signal change d'etat au milieu de chaque bit. Exemple : front montant = \(1\), front descendant = \(0\). Cette transition rend le signal AU361-Automatique-synchronisant.
:::
